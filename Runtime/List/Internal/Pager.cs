...
namespace DynamicData.List.Internal
{
        ...
        where T : notnull
    {
        ...
        private static PageChangeSet<T>? CheckParametersAndPage(System.Collections.Generic.List<T> all, ChangeAwareList<T> paged, IPageRequest? request)
        {
        ...
        private static PageChangeSet<T> Page(System.Collections.Generic.List<T> all, ChangeAwareList<T> paged, IPageRequest request, IChangeSet<T>? changeSet = null)
        {
