        ...
        where TObject : INotifyPropertyChanged
    {
        ...
        public ObservablePropertyFactory(Expression<Func<TObject, TProperty>> expression)
        {
            ...
            _factory = (t, notifyInitial) =>
            {
                ...
                var propertyChanged = Observable.FromEventPattern<PropertyChangedEventHandler, PropertyChangedEventArgs>(eh => (o,a) => eh(o,a), handler => t.PropertyChanged += handler, handler => t.PropertyChanged -= handler).Where(args => args.EventArgs.PropertyName == member.Name).Select(_ => Factory());
